            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link active" href="../documentation/getting-started.html" role="button">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3 class="mb-0">Plan d'approvisionnement</h3>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Ajouter un plan d'approvisionnement</h5>
            </div>
            <div class="card-body bg-light">
                <form action="">
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Désignation</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Désignation">
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Quantité</label>
                                <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Quantité">
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Prix Unitaire</label>
                                <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Prix Unitaire">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Valeur budgétisée">
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Fournisseur">
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Commencement d'approvisionnement</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Le mois de commencement d'approvisionnement">
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Durée de procédure</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Durée de procédure">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Raisons d'achat</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder = "Quelles sont les raisons de l'achat ?"></textarea>
                    </div>
                </form>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Setting up Build system</h5>
            </div>
            <div class="card-body bg-light">
              <p>Unzip the <code>Falcon-v3.14.0.zip</code> to any folder and open a command line or terminal at that location.
